...
\begin{figure}[ht]
\centering
\includegraphics[width=9cm]{android_structure.pdf}
\caption{Android系统架构}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=8cm]{package_structure.pdf}
	\caption{APK文件结构}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{zygote_start.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{app_start.pdf}
	\caption{应用启动过程-1}
	\label{appStart}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{app_start2.pdf}
	\caption{应用启动过程-2}
	\label{appStart2}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{class_load.pdf}
	\caption{类的加载过程}
	\label{classLoad}
\end{figure}
...
\begin{figure}[]
	\centering
	\includegraphics[width=\textwidth]{method_exec.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{method_exec2.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=6cm]{frida.pdf}
	\caption{Frida架构}
	\label{fridaArch}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=5cm]{frida_gum.pdf}
	\caption{frida-gum模块}
	\label{fridaGum}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=10cm]{frida_hook.pdf}
